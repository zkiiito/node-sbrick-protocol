...
describe('SBrickChannelAdvertismentData', function () {
    describe('#parse()', function () {
        it('valid SBrick data protocol 4.2', function () {
            let sbrickData = SBrickChannelAdvertismentData.parse('98010600000400040204010E12f007020D23FC198763020300');
        ...
        it('valid SBrick data protocol 5.17', function () {
            let sbrickData = SBrickChannelAdvertismentData.parse('98010600000500051107020D23FC1987630203000506684b4957');
